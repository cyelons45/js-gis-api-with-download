/**
 * Summary: Class to connect AWS secret manager.
 * Description: Methods in this class are used to connect AWS secret manager for retrieving DB connection details.
 */
 ...
 * @param {secretName} secretName example 'dev/psps/db_eventapi'
